...
//     restaurant.find({},function(err,locate){
//         res.render('location',{
//             restaurantlocation:locate
//         })
//     })
...
app.get("/add-to-cart/:id",async(req,res)=>{
    ...
    if(itemindex > -1){
        ...
        // const user=await users.findOne({username:n})
        // console.log(u._id)
...
app.post("/checkout",async(req,res)=>{
    try{
        ...
        const u=await users.findOne({username:n})
        const cart=await carts.findOne({user:u._id})
        // const f=await cart.items.findOne({})
